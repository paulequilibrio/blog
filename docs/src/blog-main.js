...
requestAnimationFrame(function(){self.fire('app-reset-layout');});},_notifyDescendantResize:function _notifyDescendantResize(){if(!this.isAttached){return;}this._interestedResizables.forEach(function(resizable){if(this.resizerShouldNotify(resizable)){this._notifyDescendant(resizable);}},this);}}];_exports.AppLayoutBehavior=AppLayoutBehavior;var appLayoutBehavior={AppLayoutBehavior:AppLayoutBehavior};/**
   ...
   Code distributed by Google as part of the polymer project is also
   subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
   */_exports.$appLayoutBehavior=appLayoutBehavior;Polymer$1({_template:html(_templateObject_3e9626706da111e8834a21ca814d0560),is:'app-drawer-layout',behaviors:[AppLayoutBehavior],properties:{/**
...
afterNextRender(this,function(){drawer.removeAttribute('no-transition');});}this._drawerNeedsReset=false;}},_narrowChanged:function _narrowChanged(){this._drawerNeedsReset=true;this.resetLayout();},_onQueryMatchesChanged:function _onQueryMatchesChanged(event){this._setNarrow(event.detail.value);},_computeMediaQuery:function _computeMediaQuery(forceNarrow,responsiveWidth){return forceNarrow?'(min-width: 0px)':'(max-width: '+responsiveWidth+')';}});/**
    ...
    */var $_documentContainer=document.createElement('template');$_documentContainer.setAttribute('style','display: none;');$_documentContainer.innerHTML="<custom-style>\n  <style is=\"custom-style\">\n    [hidden] {\n      display: none !important;\n    }\n  </style>\n</custom-style><custom-style>\n  <style is=\"custom-style\">\n    html {\n\n      --layout: {\n        display: -ms-flexbox;\n        display: -webkit-flex;\n        display: flex;\n      };\n\n      --layout-inline: {\n        display: -ms-inline-flexbox;\n        display: -webkit-inline-flex;\n        display: inline-flex;\n      };\n\n      --layout-horizontal: {\n        @apply --layout;\n\n        -ms-flex-direction: row;\n        -webkit-flex-direction: row;\n        flex-direction: row;\n      };\n\n      --layout-horizontal-reverse: {\n        @apply --layout;\n\n        -ms-flex-direction: row-reverse;\n        -webkit-flex-direction: row-reverse;\n        flex-direction: row-reverse;\n      };\n\n      --layout-vertical: {\n        @apply --layout;\n\n        -ms-flex-direction: column;\n        -webkit-flex-direction: column;\n        flex-direction: column;\n      };\n\n      --layout-vertical-reverse: {\n        @apply --layout;\n\n        -ms-flex-direction: column-reverse;\n        -webkit-flex-direction: column-reverse;\n        flex-direction: column-reverse;\n      };\n\n      --layout-wrap: {\n        -ms-flex-wrap: wrap;\n        -webkit-flex-wrap: wrap;\n        flex-wrap: wrap;\n      };\n\n      --layout-wrap-reverse: {\n        -ms-flex-wrap: wrap-reverse;\n        -webkit-flex-wrap: wrap-reverse;\n        flex-wrap: wrap-reverse;\n      };\n\n      --layout-flex-auto: {\n        -ms-flex: 1 1 auto;\n        -webkit-flex: 1 1 auto;\n        flex: 1 1 auto;\n      };\n\n      --layout-flex-none: {\n        -ms-flex: none;\n        -webkit-flex: none;\n        flex: none;\n      };\n\n      --layout-flex: {\n        -ms-flex: 1 1 0.000000001px;\n        -webkit-flex: 1;\n        flex: 1;\n        -webkit-flex-basis: 0.000000001px;\n        flex-basis: 0.000000001px;\n      };\n\n      --layout-flex-2: {\n        -ms-flex: 2;\n        -webkit-flex: 2;\n        flex: 2;\n      };\n\n      --layout-flex-3: {\n        -ms-flex: 3;\n        -webkit-flex: 3;\n        flex: 3;\n      };\n\n      --layout-flex-4: {\n        -ms-flex: 4;\n        -webkit-flex: 4;\n        flex: 4;\n      };\n\n      --layout-flex-5: {\n        -ms-flex: 5;\n        -webkit-flex: 5;\n        flex: 5;\n      };\n\n      --layout-flex-6: {\n        -ms-flex: 6;\n        -webkit-flex: 6;\n        flex: 6;\n      };\n\n      --layout-flex-7: {\n        -ms-flex: 7;\n        -webkit-flex: 7;\n        flex: 7;\n      };\n\n      --layout-flex-8: {\n        -ms-flex: 8;\n        -webkit-flex: 8;\n        flex: 8;\n      };\n\n      --layout-flex-9: {\n        -ms-flex: 9;\n        -webkit-flex: 9;\n        flex: 9;\n      };\n\n      --layout-flex-10: {\n        -ms-flex: 10;\n        -webkit-flex: 10;\n        flex: 10;\n      };\n\n      --layout-flex-11: {\n        -ms-flex: 11;\n        -webkit-flex: 11;\n        flex: 11;\n      };\n\n      --layout-flex-12: {\n        -ms-flex: 12;\n        -webkit-flex: 12;\n        flex: 12;\n      };\n\n      /* alignment in cross axis */\n\n      --layout-start: {\n        -ms-flex-align: start;\n        -webkit-align-items: flex-start;\n        align-items: flex-start;\n      };\n\n      --layout-center: {\n        -ms-flex-align: center;\n        -webkit-align-items: center;\n        align-items: center;\n      };\n\n      --layout-end: {\n        -ms-flex-align: end;\n        -webkit-align-items: flex-end;\n        align-items: flex-end;\n      };\n\n      --layout-baseline: {\n        -ms-flex-align: baseline;\n        -webkit-align-items: baseline;\n        align-items: baseline;\n      };\n\n      /* alignment in main axis */\n\n      --layout-start-justified: {\n        -ms-flex-pack: start;\n        -webkit-justify-content: flex-start;\n        justify-content: flex-start;\n      };\n\n      --layout-center-justified: {\n        -ms-flex-pack: center;\n        -webkit-justify-content: center;\n        justify-content: center;\n      };\n\n      --layout-end-justified: {\n        -ms-flex-pack: end;\n        -webkit-justify-content: flex-end;\n        justify-content: flex-end;\n      };\n\n      --layout-around-justified: {\n        -ms-flex-pack: distribute;\n        -webkit-justify-content: space-around;\n        justify-content: space-around;\n      };\n\n      --layout-justified: {\n        -ms-flex-pack: justify;\n        -webkit-justify-content: space-between;\n        justify-content: space-between;\n      };\n\n      --layout-center-center: {\n        @apply --layout-center;\n        @apply --layout-center-justified;\n      };\n\n      /* self alignment */\n\n      --layout-self-start: {\n        -ms-align-self: flex-start;\n        -webkit-align-self: flex-start;\n        align-self: flex-start;\n      };\n\n      --layout-self-center: {\n        -ms-align-self: center;\n        -webkit-align-self: center;\n        align-self: center;\n      };\n\n      --layout-self-end: {\n        -ms-align-self: flex-end;\n        -webkit-align-self: flex-end;\n        align-self: flex-end;\n      };\n\n      --layout-self-stretch: {\n        -ms-align-self: stretch;\n        -webkit-align-self: stretch;\n        align-self: stretch;\n      };\n\n      --layout-self-baseline: {\n        -ms-align-self: baseline;\n        -webkit-align-self: baseline;\n        align-self: baseline;\n      };\n\n      /* multi-line alignment in main axis */\n\n      --layout-start-aligned: {\n        -ms-flex-line-pack: start;  /* IE10 */\n        -ms-align-content: flex-start;\n        -webkit-align-content: flex-start;\n        align-content: flex-start;\n      };\n\n      --layout-end-aligned: {\n        -ms-flex-line-pack: end;  /* IE10 */\n        -ms-align-content: flex-end;\n        -webkit-align-content: flex-end;\n        align-content: flex-end;\n      };\n\n      --layout-center-aligned: {\n        -ms-flex-line-pack: center;  /* IE10 */\n        -ms-align-content: center;\n        -webkit-align-content: center;\n        align-content: center;\n      };\n\n      --layout-between-aligned: {\n        -ms-flex-line-pack: justify;  /* IE10 */\n        -ms-align-content: space-between;\n        -webkit-align-content: space-between;\n        align-content: space-between;\n      };\n\n      --layout-around-aligned: {\n        -ms-flex-line-pack: distribute;  /* IE10 */\n        -ms-align-content: space-around;\n        -webkit-align-content: space-around;\n        align-content: space-around;\n      };\n\n      /*******************************\n                Other Layout\n      *******************************/\n\n      --layout-block: {\n        display: block;\n      };\n\n      --layout-invisible: {\n        visibility: hidden !important;\n      };\n\n      --layout-relative: {\n        position: relative;\n      };\n\n      --layout-fit: {\n        position: absolute;\n        top: 0;\n        right: 0;\n        bottom: 0;\n        left: 0;\n      };\n\n      --layout-scroll: {\n        -webkit-overflow-scrolling: touch;\n        overflow: auto;\n      };\n\n      --layout-fullbleed: {\n        margin: 0;\n        height: 100vh;\n      };\n\n      /* fixed position */\n\n      --layout-fixed-top: {\n        position: fixed;\n        top: 0;\n        left: 0;\n        right: 0;\n      };\n\n      --layout-fixed-right: {\n        position: fixed;\n        top: 0;\n        right: 0;\n        bottom: 0;\n      };\n\n      --layout-fixed-bottom: {\n        position: fixed;\n        right: 0;\n        bottom: 0;\n        left: 0;\n      };\n\n      --layout-fixed-left: {\n        position: fixed;\n        top: 0;\n        bottom: 0;\n        left: 0;\n      };\n\n    }\n  </style>\n</custom-style>";document.head.appendChild($_documentContainer.content);var style=document.createElement('style');style.textContent='[hidden] { display: none !important; }';document.head.appendChild(style);/**
                                  ...
                                  Code distributed by Google as part of the polymer project is also
                                  subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
                                  */Polymer$1({_template:html(_templateObject2_3e9626706da111e8834a21ca814d0560),is:'app-drawer',properties:{/**
...
this.debounce('_resetDrawerState',this._resetDrawerState,this.transitionDuration);},_MIN_FLING_THRESHOLD:0.2,_MIN_TRANSITION_VELOCITY:1.2,_FLING_TIMING_FUNCTION:'cubic-bezier(0.667, 1, 0.667, 1)',_FLING_INITIAL_SLOPE:1.5,_DRAWER_STATE:{INIT:0,OPENED:1,OPENED_PERSISTENT:2,CLOSED:3,TRACKING:4,FLINGING:5/**
    ...
    Code distributed by Google as part of the polymer project is also
    subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
    */Polymer$1({_template:html(_templateObject3_3e9626706da111e8834a21ca814d0560),is:'app-header-layout',behaviors:[AppLayoutBehavior],properties:{/**
...
if(effectDef.setUp()!==false){this._effectsRunFn.push(effectDef.run);}},this);}},/**
   ...
   */_getDOMRef:function _getDOMRef(id){console.warn('_getDOMRef','`'+id+'` is undefined');},_getUndefinedMsg:function _getUndefinedMsg(effectName){return'Scroll effect `'+effectName+'` is undefined. '+'Did you forget to import app-layout/app-scroll-effects/effects/'+effectName+'.html ?';}}];_exports.AppScrollEffectsBehavior=AppScrollEffectsBehavior;var appScrollEffectsBehavior={AppScrollEffectsBehavior:AppScrollEffectsBehavior};/**
   ...
   Code distributed by Google as part of the polymer project is also
   subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
   */_exports.$appScrollEffectsBehavior=appScrollEffectsBehavior;Polymer$1({_template:html(_templateObject4_3e9626706da111e8834a21ca814d0560),is:'app-header',behaviors:[AppScrollEffectsBehavior,AppLayoutBehavior],properties:{/**
...
if(Math.abs(this._initScrollTop-scrollTop)>30||absDScrollTop>10){if(isScrollingDown&&scrollTop>=maxHeaderTop){top=maxHeaderTop;}else if(!isScrollingDown&&scrollTop>=this._dHeight){top=this.condenses&&!this.fixed?this._dHeight:0;}var scrollVelocity=dScrollTop/(now-this._lastTimestamp);this.style.transitionDuration=this._clamp((top-lastTop)/scrollVelocity,0,300)+'ms';}else{top=this._top;}}}if(this._dHeight===0){progress=scrollTop>0?1:0;}else{progress=top/this._dHeight;}if(!forceUpdate){this._lastScrollTop=scrollTop;this._top=top;this._wasScrollingDown=isScrollingDown;this._lastTimestamp=now;}if(forceUpdate||progress!==this._progress||lastTop!==top||scrollTop===0){this._progress=progress;this._runEffects(progress,top);this._transformHeader(top);}},/**
   ...
   */getScrollState:function getScrollState(){return{progress:this._progress,top:this._top};}});/**
    ...
    Code distributed by Google as part of the polymer project is also
    subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
    */Polymer$1({_template:html(_templateObject5_3e9626706da111e8834a21ca814d0560),is:'app-toolbar'});/**
    @license
    Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
    This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
    The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
paramString=(paramString||'').replace(/\+/g,'%20');var paramList=paramString.split('&');for(var i=0;i<paramList.length;i++){var param=paramList[i].split('=');if(param[0]){params[decodeURIComponent(param[0])]=decodeURIComponent(param[1]||'');}}return params;}});/**
   ...
   */_routeQueryParamsChanged:function _routeQueryParamsChanged(queryParams){if(!this.route){return;}this.queryParams=queryParams;}};_exports.AppRouteConverterBehavior=AppRouteConverterBehavior;var appRouteConverterBehavior={AppRouteConverterBehavior:AppRouteConverterBehavior};/**
   ...
   Code distributed by Google as part of the polymer project is also
   subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
   */_exports.$appRouteConverterBehavior=appRouteConverterBehavior;Polymer$1({_template:html(_templateObject6_3e9626706da111e8834a21ca814d0560),is:'app-location',properties:{/**
     * A model representing the deserialized path through the route tree, as
     * well as the current queryParams.
     */route:{type:Object,notify:true},/**
...
_exports.IronMeta=IronMeta;IronMeta[' ']=function(){};IronMeta.types={};IronMeta.prototype={get value(){var type=this.type;var key=this.key;if(type&&key){return IronMeta.types[type]&&IronMeta.types[type][key];}},set value(value){var type=this.type;var key=this.key;if(type&&key){type=IronMeta.types[type]=IronMeta.types[type]||{};if(value==null){delete type[key];}else{type[key]=value;}}},get list(){var type=this.type;if(type){var items=IronMeta.types[this.type];if(!items){return[];}return Object.keys(items).map(function(key){return metaDatas[this.type][key];},this);}},byKey:function byKey(key){this.key=key;return this.value;}};var metaDatas=IronMeta.types;Polymer$1({is:'iron-meta',properties:{/**
   ...
   */byKey:function byKey(key){return new IronMeta({type:this.type,key:key}).value;}});var ironMeta={IronMeta:IronMeta};/**
   ...
   Code distributed by Google as part of the polymer project is also
   subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
   */_exports.$ironMeta=ironMeta;Polymer$1({_template:html(_templateObject7_3e9626706da111e8834a21ca814d0560),is:'iron-icon',properties:{/**
...
this.fire('iron-items-changed',mutation,{bubbles:false,cancelable:false});});},_activateHandler:function _activateHandler(e){var t=e.target;var items=this.items;while(t&&t!=this){var i=items.indexOf(t);if(i>=0){var value=this._indexToValue(i);this._itemActivate(value,t);return;}t=t.parentNode;}},_itemActivate:function _itemActivate(value,item){if(!this.fire('iron-activate',{selected:value,item:item},{cancelable:true}).defaultPrevented){this.select(value);}}};_exports.IronSelectableBehavior=IronSelectableBehavior;var ironSelectable={IronSelectableBehavior:IronSelectableBehavior};/**
   ...
   Code distributed by Google as part of the polymer project is also
   subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
   */_exports.$ironSelectable=ironSelectable;Polymer$1({_template:html(_templateObject9_3e9626706da111e8834a21ca814d0560),is:'iron-pages',behaviors:[IronResizableBehavior,IronSelectableBehavior],properties:{// as the selected page is the only one visible, activateEvent
...
if(!label||oldValue==label){this.setAttribute('aria-label',newValue);}}});var BlogAbout=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(BlogAbout,_LitElement);function BlogAbout(){babelHelpers.classCallCheck(this,BlogAbout);return babelHelpers.possibleConstructorReturn(this,(BlogAbout.__proto__||Object.getPrototypeOf(BlogAbout)).apply(this,arguments));}babelHelpers.createClass(BlogAbout,[{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(BlogAbout.prototype.__proto__||Object.getPrototypeOf(BlogAbout.prototype),"connectedCallback",this).call(this);}},{key:"disconnectedCallback",value:function disconnectedCallback(){babelHelpers.get(BlogAbout.prototype.__proto__||Object.getPrototypeOf(BlogAbout.prototype),"disconnectedCallback",this).call(this);}},{key:"_render",value:function _render(_ref){var title=_ref.title;return html$2(_templateObject11_3e9626706da111e8834a21ca814d0560);// <p>Última modificação em ${moment('2018-06-11').format('LL')}.</p>
}}],[{key:"properties",get:function get(){return{title:{type:String,reflectToAttribute:true}};}}]);return BlogAbout;}(LitElement);_exports.BlogAbout=BlogAbout;window.customElements.define('blog-about',BlogAbout);var blogAbout={BlogAbout:BlogAbout};_exports.$blogAbout=blogAbout;var PostList=/*#__PURE__*/function(_LitElement2){babelHelpers.inherits(PostList,_LitElement2);function PostList(){babelHelpers.classCallCheck(this,PostList);return babelHelpers.possibleConstructorReturn(this,(PostList.__proto__||Object.getPrototypeOf(PostList)).call(this));}babelHelpers.createClass(PostList,[{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(PostList.prototype.__proto__||Object.getPrototypeOf(PostList.prototype),"connectedCallback",this).call(this);}},{key:"disconnectedCallback",value:function disconnectedCallback(){babelHelpers.get(PostList.prototype.__proto__||Object.getPrototypeOf(PostList.prototype),"disconnectedCallback",this).call(this);}},{key:"_render",value:function _render(_ref2){var posts=_ref2.posts;return html$2(_templateObject12_3e9626706da111e8834a21ca814d0560,posts);}}],[{key:"properties",get:function get(){return{posts:Object};}}]);return PostList;}(LitElement);_exports.PostList=PostList;window.customElements.define('post-list',PostList);var postList={PostList:PostList};_exports.$postList=postList;var PostView=/*#__PURE__*/function(_LitElement3){babelHelpers.inherits(PostView,_LitElement3);function PostView(){babelHelpers.classCallCheck(this,PostView);return babelHelpers.possibleConstructorReturn(this,(PostView.__proto__||Object.getPrototypeOf(PostView)).call(this));}babelHelpers.createClass(PostView,[{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(PostView.prototype.__proto__||Object.getPrototypeOf(PostView.prototype),"connectedCallback",this).call(this);}},{key:"disconnectedCallback",value:function disconnectedCallback(){babelHelpers.get(PostView.prototype.__proto__||Object.getPrototypeOf(PostView.prototype),"disconnectedCallback",this).call(this);}},{key:"attributeChangedCallback",value:function attributeChangedCallback(name,b,c){babelHelpers.get(PostView.prototype.__proto__||Object.getPrototypeOf(PostView.prototype),"attributeChangedCallback",this).call(this);// console.log(name, b, c)
}},{key:"loadHtml",value:function loadHtml(post){var _this36=this;if(post&&post.filename){return new Promise(function(resolve,reject){window.fetch("posts/".concat(post.filename)).then(function(response){return response.text();}).then(function(content){// console.log(content)
_this36.content=html$2([content]);resolve(content);}).catch(function(e){return reject(e);});});}}},{key:"_shouldRender",value:function _shouldRender(props,changedProps,prevProps){if(changedProps&&'post'in changedProps){this.loadHtml(changedProps.post);}return true;}},{key:"_render",value:function _render(props){return html$2(_templateObject13_3e9626706da111e8834a21ca814d0560,props.content);}}],[{key:"properties",get:function get(){return{post:Object,content:String};}},{key:"observedAttributes",get:function get(){return['slug','post'];}}]);return PostView;}(LitElement);_exports.PostView=PostView;window.customElements.define('post-view',PostView);var postView={PostView:PostView};_exports.$postView=postView;var BlogMain=/*#__PURE__*/function(_LitElement4){babelHelpers.inherits(BlogMain,_LitElement4);function BlogMain(){var _this37;babelHelpers.classCallCheck(this,BlogMain);_this37=babelHelpers.possibleConstructorReturn(this,(BlogMain.__proto__||Object.getPrototypeOf(BlogMain)).call(this));setPassiveTouchGestures(true);return _this37;}babelHelpers.createClass(BlogMain,[{key:"setRoute",value:function setRoute(){this.appRoute.route=this.appLocation.route;this.slug=this.appRoute.tail.path;this.page=this.appRoute.data.page;}},{key:"loadList",value:function loadList(){var _this38=this;return new Promise(function(resolve,reject){window.fetch('posts/post-list.json').then(function(response){return response.json();}).then(function(posts){_this38.posts=posts;resolve(posts);}).catch(function(e){return reject(e);});});}},{key:"selectPost",value:function selectPost(posts){var _this39=this;this.postView.post=posts.find(function(post){return post.slug===_this39.slug.slice(1);});}},{key:"load",value:function load(event){if(this.appDrawerLayout.narrow)this.appDrawer.close();if(event.detail.item.localName==='post-list'){if(!this.posts){this.loadList();}}if(event.detail.item.localName==='post-view'){if(!this.posts){this.loadList().then(this.selectPost.bind(this)).catch(function(e){return console.error(e);});}else{this.selectPost(this.posts);}}}},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(BlogMain.prototype.__proto__||Object.getPrototypeOf(BlogMain.prototype),"connectedCallback",this).call(this);// this.shadowRoot.querySelector('app-drawer-layout').responsiveWidth = '10px'
this.appDrawerLayout=this.shadowRoot.querySelector('app-drawer-layout');this.appDrawer=this.shadowRoot.querySelector('app-drawer');this.appLocation=this.shadowRoot.querySelector('app-location');this.appRoute=this.shadowRoot.querySelector('app-route');this.ironPages=this.shadowRoot.querySelector('iron-pages');this.postList=this.shadowRoot.querySelector('post-list');this.postView=this.shadowRoot.querySelector('post-view');this.appLocation.addEventListener('path-changed',this.setRoute.bind(this));this.ironPages.addEventListener('iron-select',this.load.bind(this));setInterval(this.update,1000,this);if(!this.appRoute.data.page){this.setRoute();}if(!this.page){this.appLocation.path='/post-list';}}},{key:"disconnectedCallback",value:function disconnectedCallback(){babelHelpers.get(BlogMain.prototype.__proto__||Object.getPrototypeOf(BlogMain.prototype),"disconnectedCallback",this).call(this);}},{key:"setHues",value:function setHues(primaryHue,secondaryHue){this.style.setProperty('--primary-hue',primaryHue);this.style.setProperty('--secondary-hue',secondaryHue);}},{key:"setSaturations",value:function setSaturations(primarySaturation,secondarySaturation){this.style.setProperty('--primary-saturation',"".concat(primarySaturation,"%"));this.style.setProperty('--secondary-saturation',"".concat(secondarySaturation,"%"));}},{key:"_render",value:function _render(_ref3){var page=_ref3.page,posts=_ref3.posts,slug=_ref3.slug;return html$2(_templateObject14_3e9626706da111e8834a21ca814d0560,page,posts);}}],[{key:"properties",get:function get(){return{page:String,posts:Array,slug:String,appLocation:Object,appRoute:Object};}}]);return BlogMain;}(LitElement);_exports.BlogMain=BlogMain;window.customElements.define('blog-main',BlogMain);var blogMain={BlogMain:BlogMain};_exports.$blogMain=blogMain;});